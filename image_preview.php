...
function confirmAndPay(){
	if(navigator.appName == "Microsoft Internet Explorer"){
		document.location.href("<?php echo $SERVER_URL; ?>ad_payment.php?id=<?php echo $id; ?>&type=image");
	}else{
		window.location = "<?php echo $SERVER_URL; ?>ad_payment.php?id=<?php echo $id; ?>&type=image";
	}
}
