...
<script language="JavaScript">
	...
	function loadTextAdvertisementEntry(){
		if(navigator.appName == "Microsoft Internet Explorer"){
			document.location.href("<?php echo $SERVER_URL; ?>ad_entry.php");
		}else{
			window.location = "<?php echo $SERVER_URL; ?>ad_entry.php";
		}		
	}
	
	function loadImageAdvertisementEntry(){
		if(navigator.appName == "Microsoft Internet Explorer"){
			document.location.href("<?php echo $SERVER_URL; ?>ad_image_entry.php");
		}else{
			window.location = "<?php echo $SERVER_URL; ?>ad_image_entry.php";
		}		
	}	
	
	function loadTenderNoticeEntry(){
		if(navigator.appName == "Microsoft Internet Explorer"){
			document.location.href("<?php echo $SERVER_URL; ?>tender_notice_entry.php");
		}else{
			window.location = "<?php echo $SERVER_URL; ?>tender_notice_entry.php";
		}		
	}
    ...
    <td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="text">
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="2" class="style1">Login to PaperNET!</td>
            </tr>
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>Passowrd</td>
            <td><input type="password" name="password" id="password" class="text" onKeyPress="searchKeyPress(event);"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td><input type="button" name="button" id="button" value="Login" class="text" onClick="validateLogin();">
							      <input type="button" name="button2" id="button2" value="Reset" class="text" onClick="resetPage();"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><a href="register.php">Register with us!</a></td>
          </tr>
